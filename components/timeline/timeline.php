...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/material-design-iconic-font/2.2.0/css/material-design-iconic-font.min.css">
    ...
    <div class="px-4 py-1 my- mt- text-center">
        <h1 class="display-6 fw-bold"> Cestovní deník</h1>
        <div class="col-lg-6 mx-auto">
            <p class="lead mb-4"> Jsme dobrodruzi i dvoučlená rodina, putující krajinou života bez stálého přístavu,
                naše domovy jsou tam, kde rozprostřeme stan. V srdci nosíme plamen anarchie, v žilách nám pulsuje
                kapitalistická krev.

                Náš život jsme utkali tak, aby otěže našich osudů nebyly svázány s pravidly státu, ale s pocity našich
                srdcí.</p>
        </div>
        <svg class="fill-dark opacity-5" width="30%" viewBox="0 0 400 145" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="row">
            <div class="col-md-10">
                <ul class="cbp_tmtimeline">
                    <li>
                        <time class="cbp_tmtime" datetime="2017-11-04T18:30"><span class="hidden">Již brzy</span>
                            <span>Od nejnovějších</span></time>
                        <div class="cbp_tmicon"><i class="zmdi zmdi-account"></i></div>
                        <div class="cbp_tmlabel empty"> <span>Ať už prší či svítí slunce, každý týden vám přineseme
                                alespoň jeden příběh z cest, plný dobrodružství a objevů.</span> </div>
                    </li>
                    <li>
                        <time class="cbp_tmtime" datetime="2017-11-04T03:45"><span>13:17
                                🇨🇿</span><span>Dnes</span></time>
                        <div class="cbp_tmicon bg-info"><i class="zmdi zmdi-label"></i></div>
                        <div class="cbp_tmlabel">
                            <h2><span> Místo: </span><a href="javascript:void(0);">Brno</a></h2>
                    ...
                    <li>
                        <time class="cbp_tmtime" datetime="2017-11-03T13:22"><span>7:26 🇵🇾</span>
                            <span>Včera</span></time>
                        <div class="cbp_tmicon bg-green"> <i class="zmdi zmdi-male-female"></i></div>
                        <div class="cbp_tmlabel">
                    ...
                    <li>
                        <time class="cbp_tmtime" datetime="2017-11-04T03:45"><span>13:17
                                🇨🇿</span><span>Tento týden</span></time>
                        <div class="cbp_tmicon bg-info"><i class="zmdi zmdi-label"></i></div>
                        <div class="cbp_tmlabel">
                            <h2><span> Místo: </span><a href="javascript:void(0);">Brno</a></h2>
                            <p>Tolerably earnestly middleton extremely distrusts she boy now not. Add and offered
                    ...
                    <li>
                        <time class="cbp_tmtime" datetime="2017-10-22T12:13"><span>12:13 🇫🇷</span> <span>Před
                                týdnem</span></time>
                    ...
                    <li>
                        <time class="cbp_tmtime" datetime="2017-10-22T12:13"><span>12:13 🇵🇾</span> <span>Dva týdny na
                                zpět</span></time>
                        <div class="cbp_tmicon bg-orange"><i class="zmdi zmdi-camera"></i></div>
                        <div class="cbp_tmlabel">
                            <h2><span>Nahrál jsem 4 nové fotky</span> <a href="javascript:void(0);">Summer Trip</a></h2>
                            <blockquote>Pianoforte principles our unaffected not for astonished travelling are
                                particular.</blockquote>
                            <div class="row">
                                <div class="col-lg-3 col-md-6 col-6"><a href="https://dobrodruzi.cz/img/blog/sm-b1.jpg"><img src="https://dobrodruzi.cz/img/blog/sm-b1.jpg" alt class="img-fluid img-thumbnail m-t-30"></a> </div>
                                <div class="col-lg-3 col-md-6 col-6"><a href="javascript:void(0);"> <img src="https://dobrodruzi.cz/img/blog/sm-b4.jpg" alt class="img-fluid img-thumbnail m-t-30"></a> </div>
                                <div class="col-lg-3 col-md-6 col-6"><a href="javascript:void(0);"> <img src="https://dobrodruzi.cz/img/blog/sm-b2.jpg" alt class="img-fluid img-thumbnail m-t-30">
                                    </a> </div>
                                <div class="col-lg-3 col-md-6 col-6"><a href="javascript:void(0);"> <img src="https://dobrodruzi.cz/img/blog/sm-b8.jpg" alt class="img-fluid img-thumbnail m-t-30">
                                    </a> </div>
                            </div>
                        </div>
                    </li>
                    <li>
                        <time class="cbp_tmtime" datetime="2017-11-03T13:22"><span>11:22 🇵🇾</span> <span>Tři týdny
                                na zpět</span></time>
                        <div class="cbp_tmicon bg-green"> <i class="zmdi zmdi-local-cafe"></i></div>
                        <div class="cbp_tmlabel">
                            <h2><a href=""></a></h2>
                            <p>Našel jsem skvělou kavárnu <strong><a href="">Rose</a></strong> v centru Dubaje.</p>
                        </div>
                    </li>
                    <li>
                        <time class="cbp_tmtime" datetime="2017-10-22T12:13"><span>13:15 🇵🇾</span> <span>Před
                                měsícem</span></time>
                        <div class="cbp_tmicon bg-blush"><i class="zmdi zmdi-bus"></i></div>
                        <div class="cbp_tmlabel">

                            <p>Jedu z letiště autobusem do Dubaje.</p>
                        </div>
                    </li>


                    <li>
                        <time class="cbp_tmtime" datetime="2017-10-22T12:13"><span>13:15 🇵🇾</span> <span>4.3. 2024</span></time>
                        <div class="cbp_tmicon bg-blush"><i class="zmdi zmdi-airplane"></i></div>
                        <div class="cbp_tmlabel">
                            <p>Už jsem na letišti v Somálsku, a zrovna mě okradli.</p>
                        </div>
                    </li>
                </ul>
            </div>
