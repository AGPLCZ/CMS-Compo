		...
		<div class="swiper overflow-hidden pt-5" data-swiper-options='{
			...
			<div class="swiper-wrapper">
				...
				<div class="swiper-slide">
					<div class="card overflow-hidden h-500px h-xl-750px rounded-0" style="background-image:url(<?php echo $this->url ?>/assets/template/mizzle/images/slider2.jpg); background-position: center left; background-size: cover;">
						<!-- Bg overlay -->
							...
							<div class="container">
								<div class="row">
									<div class="col-sm-11 col-lg-8 col-xl-5">
										<span class="d-inline-block text-bg-dark small rounded-pill px-3 py-2 mb-4">New release mizz-VR</span>
										<!-- Title -->
										<h1 class="text-white display-6 mb-4">Dive into Virtual Reality Adventure</h1>
	
										<p class="text-white mb-4"> Whether you're a gaming enthusiast or simply seeking an extraordinary escape from reality, our Virtual VR product is your portal to endless excitement. </p>
										<a class="btn btn-lg btn-outline-white icon-link icon-link-hover mb-0" href="#">Show details<i class="bi bi-arrow-right"></i> </a>
									</div>
								</div>
							</div>
						</div>
				...
				<!-- Slider item -->
				<div class="swiper-slide">
					<div class="card overflow-hidden h-500px h-xl-750px rounded-0" style="background-image:url(<?php echo $this->url ?>/assets/template/mizzle/images/slider1.jpg); background-position: center left; background-size: cover;">
						<!-- Bg overlay -->
						<div class="bg-overlay bg-dark opacity-5 d-lg-none"></div>
						<!-- Card image overlay -->
						<div class="card-img-overlay d-flex align-items-center"> 
							<div class="container">
								<div class="row">
									<div class="col-md-11 col-lg-8 col-xl-5 ms-auto">
										...
										<p class="fs-4 fw-normal text-white mb-3">Festival Collection <span class="text-bg-dark rounded px-3">2023</span></p>
										<!-- Title -->
										<h1 class="text-white display-4 mb-3">FLAT 50% OFF</h1>
	
										<p class="text-white mb-4"> Step into a world of quality and craftsmanship – it's time to put your best foot forward.</p>
										<a class="btn btn-lg btn-dark icon-link icon-link-hover mb-0" href="#">Show now<i class="bi bi-arrow-right"></i> </a>
									</div>
								</div>
							</div>
						</div>
        ...
        <div class="row gx-4">
            <div class="col-lg-4 mb-5">
                <div class="card h-100 shadow border-0">
                    <img class="card-img-top" src="<?php echo $this->url ?>/assets/template/mizzle/images/blog01.jpg" alt="..." />
                    <div class="card-body p-4">
                        ...
                        <ul class="card-meta list-inline">
                                      <li class="list-inline-item">
                                          <i class="bi bi-globe-americas"></i>Technické vybavení
                                          </a>
                                      </li>
                                      <li class="list-inline-item">
                                          <i class="ti-shopping-cart"></i><a href="https://shop.nitrokey.com/shop/nitrowall-nw750-590?search=nitrowall#attr=1047" class="text-primary">Odkaz na eshop</a>
                                      </li>

                                      <li class="list-inline-item">
                                          <ul class="card-meta-tag list-inline">
                                              <li class="list-inline-item"><a href="/articles/?tag=pro-nomady">Pro nomády</a></li>
                                              <li class="list-inline-item"><a href="/articles/?tag=pro-cestovatele">Pro cestovatele</a></li>
                                              <li class="list-inline-item"><a href="/articles/?tag=soukromi">Soukromí</a></li>
                                          </ul>
                                      </li>
                                  </ul>
                    ...
                    <div class="card-footer p-4 pt-0 bg-transparent border-top-0">
                        <div class="d-flex align-items-end justify-content-between">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="small">
                                <a href="https://filipraboch.com/en-cz" class="btn btn-outline-primary">Odkaz na výrobce</a>
                                </div>
                            </div>
                        </div>
                    </div>
		...
		<div class="row g-4 g-sm-5 g-xl-7 mt-0">
			...
			<div class="col-md-6 col-lg-4">
				<article class="card bg-transparent h-100 p-0">
					...
					<!-- Card image -->
					<img src="<?php echo $this->url ?>/assets/template/mizzle/images/blog01.jpg" class="card-img" alt="Blog-img">
			...
			<div class="col-md-6 col-lg-4">
				<article class="card bg-transparent h-100 p-0">
					<!-- Badge -->
					<div class="badge text-bg-dark position-absolute top-0 start-0 m-3">Lifestyle</div>
					...
					<div class="card-body px-2 pb-4">
						<!-- Title -->
						<h6 class="card-title mb-2"><a href="#">The Power of Gratitude: Cultivating Joy and Abundance</a></h6>
						<p class="small mb-0">By focusing on a niche, you can establish yourself as an authority and build a dedicated community.</p>
					</div>
					
					<!-- Card footer -->
					<div class="card-footer bg-transparent d-flex justify-content-between px-2 py-0">
						<span class="heading-color fw-semibold mb-0">Carolyn Ortiz</span>
				...
				<article class="card bg-dark p-4 overflow-hidden h-100" data-bs-theme="dark">
					...
					<div class="card-body p-0">
						...
						<div class="d-flex justify-content-between mb-5">
							...
							<div class="badge bg-primary text-white small">Podcast</div>
						</div>
						<!-- Title -->
						<h5 class="card-title"><a href="#">Collaborating to drive innovation in the Tech industry</a></h5>
					</div>
					...
					<div class="card-footer bg-transparent p-0 d-flex justify-content-between mt-8">
						...
						<div class="avatar flex-shrink-0">
							<img class="avatar-img rounded-circle" src="<?php echo $this->url ?>/assets/template/mizzle/images/blog01.jpg" alt="avatar">
						</div>
					</div>
				</article>
			</div>
			...
			<div class="col-md-6 col-lg-4">
				<article class="card bg-transparent h-100 p-0">
					...
					<div class="card-body px-2 pb-4">
						<!-- Title -->
						<h6 class="card-title mb-2"><a href="#">Effortless Web Development with Mizzle</a></h6>
						<p class="small mb-0">Building a successful blog takes dedication. Don't be discouraged by slow growth in the early stages.</p>
					</div>
					
					<!-- Card footer -->
					<div class="card-footer bg-transparent d-flex justify-content-between px-2 py-0">
						<span class="heading-color fw-semibold mb-0">Lori Stevens</span>
						<a class="icon-link icon-link-hover stretched-link" href="blog-single-v1.html">Read more<i class="bi bi-arrow-right"></i> </a>
					</div>
				</article>
			</div>
			...
			<div class="col-md-6 col-lg-4">
				<article class="card bg-transparent h-100 p-0">
					...
					<div class="card-body px-2 pb-4">
						<!-- Title -->
						<h6 class="card-title mb-2"><a href="#">Ten questions you should answer truthfully.</a></h6>
						<p class="small mb-0"> Remember, blogging is a continuous learning process, so stay open to new ideas.</p>
					</div>
					
					<!-- Card footer -->
					<div class="card-footer bg-transparent d-flex justify-content-between px-2 py-0">
						<span class="heading-color fw-semibold mb-0">Louis Crawford</span>
						<a class="icon-link icon-link-hover stretched-link" href="blog-single-v2.html">Read more<i class="bi bi-arrow-right"></i> </a>
					</div>
				</article>
			</div>
			...
			<div class="col-md-6 col-lg-4">
				<article class="card bg-transparent h-100 p-0">
					...
					<div class="card-body px-2 pb-4">
						<!-- Title -->
						<h6 class="card-title mb-2"><a href="#">Mastering Responsive Web Design with Bootstrap</a></h6>
						<p class="small mb-0">Focus on creating valuable content, implementing and continuously improving your blog.</p>
					</div>
					
					<!-- Card footer -->
					<div class="card-footer bg-transparent d-flex justify-content-between px-2 py-0">
						<span class="heading-color fw-semibold mb-0">Joan Wallace</span>
						<a class="icon-link icon-link-hover stretched-link" href="blog-single-v1.html">Read more<i class="bi bi-arrow-right"></i> </a>
					</div>
				</article>
			</div>
			...
			<div class="col-md-6 col-lg-4">
				<article class="card bg-primary p-4 overflow-hidden h-100">
					...
					<div class="position-absolute end-0 bottom-0 mb-n5 me-n7">
						<img src="<?php echo $this->url ?>/assets/template/mizzle/images/pattern.svg" class="opacity-4" alt="">
					</div>
			...
			<div class="col-md-6 col-lg-4">
				<article class="card bg-transparent h-100 p-0">
					...
					<div class="card-body px-2 pb-4">
						<!-- Title -->
						<h6 class="card-title mb-2"><a href="#">5 investment doubts you should clarify</a></h6>
						<p class="small mb-0">Remember, blogging is a continuous learning process, so stay open to new ideas</p>
					</div>
