			...
			<div class="app-card-body">
				<div class="table-responsive">
					...
					<tr class="p-2">
						...
						<td class="cell">
							<form method="POST" action="editComponentsListComponentsId.php"><input type="hidden" name="editComponentsListComponentsId" value="<?= htmlspecialchars($row['components_id']) ?>"><button type="submit" class="btn-sm app-btn-secondary" name="submitComponent"><i class="bi bi-pencil-square text-info"></i> Change</button></form>
						</td>
						<td class="cell"></td>
						...
						<td class="cell">
							<form method="POST" action="editComponentsListContentsId.php"><input type="hidden" name="editComponentsListContentsId" value="<?= htmlspecialchars($row['contents_id']) ?>"><button type="submit" class="btn-sm app-btn-secondary" name="submitContentId"><i class="bi bi-pencil-square text-success"></i> Change</button></form>
						</td>

						<td class="cell">
							<form method="POST" action="editComponentsListContentsName.php"><input type="hidden" name="editComponentsListContentsName" value="<?= htmlspecialchars($row['contents_id']) ?>"><button type="submit" class="btn-sm app-btn-secondary" name="submitContentName"><i class="bi bi-pencil-square text-success"></i> Rename</button></form>
						</td>
						...
						<td class="cell">
							<form method="POST" action="EditComponentsOrder/">
								...
								<input type="hidden" name="components_id" value="<?= htmlspecialchars($row['components_id']) ?>">
								<button type="submit" class="btn-sm app-btn-secondary" name="submitContentOrder">
						...
						<td class="cell">
							<form method="POST" action="deleteComponets/">
								<input type="hidden" name="deleteComponents" value="<?= htmlspecialchars($row['components_id']) ?>">
								<button type="submit" class="btn-sm app-btn-secondary text-danger" name="submitComponentsDel">
									Drop item
								</button>
							</form>
						</td>
