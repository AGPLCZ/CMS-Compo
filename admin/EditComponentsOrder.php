												...
												<form method="POST" action="<?php echo htmlspecialchars($formData['action_url']); ?>" method="post" class="form-signup">
													...
													<div class="form-group">
														...
														<div class="mb-3">
															...
															<input type="hidden" name="back_url" value="<?php echo htmlspecialchars($formData['back_url']); ?>">
															<input type="hidden" name="components_id" value="<?php echo htmlspecialchars($formData['components_id']); ?>">
														
															<div class="mb-3">
																<label for="setting-input-1" class="form-label">tittle1</label>
																<textarea type="text" name="order" class="form-control" rows="2" placeholder=""><?php echo htmlspecialchars($formData['order']); ?></textarea>
															</div>
														</div>
														<div class="mb-3">
