<div class="app-wrapper">
    <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
            ...
            <hr class="my-4">
            <div class="tab-content" id="assign-content-tab-content">
                <div class="tab-pane fade show active" id="assign-content" role="tabpanel">
                    <div class="app-card app-card-settings shadow-sm p-4">
                        <div class="app-card-body">
                            <?php if (!empty($formData)) : ?>
                                <form method="post" action="assignContent.php">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="content_name" class="form-control" value="<?= htmlspecialchars($formData['name'] ?? ''); ?>" disabled>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <button type="submit" name="assignContent" class="btn app-btn-primary">Přiřadit obsah</button>
                                        <a href="components.php" class="btn btn-secondary">Zpět</a>
                                    </div>
                                </form>
                            <?php else : ?>
